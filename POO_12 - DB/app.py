...
class App:
    ...
    def atualizar(self):
        ...
        if id and nome and email:
            cliente = Cliente(id=int(id), nome=nome, email=email)
            self.dao.atualizar(cliente)
            messagebox.showinfo("Atualizado", "Usuário atualizado com sucesso!")
            self.limpar_campos()
        else:
    ...
    def deletar(self):
        ...
        if id:
            ...
            messagebox.showinfo("Deletado", "Cliente se fodeu!!")
            self.limpar_campos()
        else:
            messagebox.showwarning("Erro", "Operador desastrado, informe o ID!!")
